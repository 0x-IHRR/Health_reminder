# HealthReminder GitHub Intro - Design Reference
...
- GitHub link blue: `#4493F8`
- Success green: `#238636`
- Accent coral: `#FF7B72`

## Typography

- Primary UI/display: `Mona Sans VF`, `PingFang SC`, system sans-serif
- Code and commands: `SFMono-Regular`, `Menlo`, `Consolas`, monospace
- Use heavy display weights for short claims and monospaced blocks for install commands.
...
- Do not use wellness stock imagery.
- Do not use bright marketing gradients.
- Do not invent features beyond the README.
- Do not over-style the GitHub page; preserve the developer utility feel.
